...
<body>
	<div class="container">
		...
		<div class="row">
			<form method="post" action="front.do?command=updatePost">
					...
					<tbody>
						...
						<tr>
							...
							<td colspan="5"><input type="text" class="form-control"
								placeholder="제목을 입력해주세요" name="title" maxlength="50" value="${avo.title}"></td>
						</tr>
						<tr>
							<td>내용</td>
							<td colspan="5"><input type="text" class="form-control"
								placeholder="내용을 입력해주세요" name="content" maxlength="2048"
								style="height: 350px;" value="${avo.content}">></td>
						</tr>
						<tr>
							<td>첨부</td>
							<td colspan="5"><input type="text" class="form-control"
								name="imgFileName" placeholder="이미지링크를 넣어주세요" value="${avo.imgFileName}"></td>
						</tr>
					</tbody>
				</table>
				<input type="submit" class="btn btn-primary" value="수정하기">
				<button onclick="location.href='home.jsp'">취소</button>
			</form>
		</div>
	</div>
</body>
